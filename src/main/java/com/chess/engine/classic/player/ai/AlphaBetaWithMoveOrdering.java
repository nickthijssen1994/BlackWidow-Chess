	...
	public Move execute(final Board board) {
		...
		for (final Move move : this.moveSorter.sort(board.currentPlayer().getLegalMoves())) {
			...
			if (moveTransition.getMoveStatus().isDone()) {
				...
				currentValue = alliance.isWhite() ? min(moveTransition.getToBoard(), this.searchDepth - 1,
						highestSeenValue, lowestSeenValue) : max(moveTransition.getToBoard(), this.searchDepth - 1,
				...
				final String quiescenceInfo =
						" [h: " + highestSeenValue + " l: " + lowestSeenValue + "] q: " + this.quiescenceCount;
				s =
