...
public class TestIterativeDeepening {
	...
	public void testOpeningDepth4BlackMovesFirst() {
		...
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("b8"),
	...
	public void eloTest1() {
		...
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("c8"),
	...
	public void testQualityDepth7() {
		...
		final MoveStrategy iterativeDeepening = new IterativeDeepening(7);
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("f7"),
	...
	public void testQualityTwoDepth6() {
		...
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("h4"),
				BoardUtils.INSTANCE.getCoordinateAtPosition("f4")));
	}
	...
	public void testQualityFourDepth6() {
		final Board board = FenUtilities.createGameFromFEN("r1b1k2r/pp3pbp/1qn1p1p1/2pnP3/3p1PP1/1P1P1NBP/P1P5" +
				"/RN1QKB1R b KQkq - 2 11");
		final MoveStrategy iterativeDeepening = new IterativeDeepening(6);
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("d5"),
	...
	public void eloTest2() {
		...
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("g5"),
				BoardUtils.INSTANCE.getCoordinateAtPosition("h7")));
	}
	...
	public void eloTest3() {
		...
		final MoveStrategy iterativeDeepening = new IterativeDeepening(6);
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("g3"),
	...
	public void testCheckmateHorizon() {
		...
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("g2"),
	...
	public void testBlackInTrouble() {
		...
		final MoveStrategy iterativeDeepening = new IterativeDeepening(4);
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("e4"),
				BoardUtils.INSTANCE.getCoordinateAtPosition("e8")));
	}
	...
	public void runawayPawn() {
		...
		final MoveStrategy iterativeDeepening = new IterativeDeepening(5);
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("a4"),
	...
	public void testMackHackScenario() {
		...
		final MoveStrategy iterativeDeepening = new IterativeDeepening(8);
		final Move bestMove = iterativeDeepening.execute(board);
		assertEquals(bestMove, Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("f8"),
